...
public class MainActivity extends AppCompatActivity {
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    Log.d("TAG_IMAGE", "FILE Save::---&gt;" + path);
    ...
    requestMultiplePermissions();
        btn_gambar_lainnya = (Button) findViewById(R.id.btn_gambar_lainny);
...
public void onClick(View v) {
        ...
        btn_gambar_lainnya.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, galeryphoto.class);
